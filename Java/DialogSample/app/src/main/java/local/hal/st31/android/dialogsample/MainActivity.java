...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * シンプルダイアログ表示ボタンが押された時のイベント処理用メソッド。
     *
     * @param view 画面部品。
     */
    ...
    /**
     * 通常ダイアログ表示ボタンが押された時のイベント処理用メソッド。
     *
     * @param view 画面部品。
     */
    ...
    /**
     * メッセージ表示ダイアログ表示ボタンが押された時のイベント処理用メソッド。
     *
     * @param view 画面部品。
     */
    ...
    private class DatePickerDialogDateSetListener implements DatePickerDialog.OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
            String msg = "日付ダイアログ: " + year + "年" + (month + 1) + "月" + dayOfMonth + "日";
    ...
    private class TimePickerDialogTimeSetListener implements TimePickerDialog.OnTimeSetListener {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minuite) {
            String msg = "時間選択ダイアログ: " + hourOfDay + "時" + minuite + "分";
            Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
        }
    }
}